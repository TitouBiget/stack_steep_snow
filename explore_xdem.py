...
flist = glob.glob('/home/bigett/Bureau/03_verte/tri_image/*')
...
for file in flist:
    ...
    lis.append(dd.band_data.isel(band=0).astype('uint16'))
...
if True:
    ...
    snow = ds.spot.isel(time=1).where(ds.mask).values 
    ...
    ds['snow_patches_1'] = (('y','x'), snow_patches)
    ds['rocks_1'] = (('y','x'), rocks)
...
if True:
    ...
    ds['snow_patches_2'] = (('y','x'), snow_patches)
    ds['rocks_2'] = (('y','x'), rocks)
...
# ds['slope_horn_diff'] = (('y','x'), xdem.terrain.slope(dem, resolution = (1.5, 1.5)))
# ds['slope_zevenberg_diff'] = (('y','x'), xdem.terrain.slope(dem, method="ZevenbergThorne", resolution = (1.5, 1.5)))
# ds['curv_diff'] = (('y','x'), xdem.terrain.curvature(dem, resolution = (1.5, 1.5)))
# ds['TPI_diff'] = (('y','x'), xdem.terrain.topographic_position_index(dem, 15))
# ds['TRI_diff'] = (('y','x'), xdem.terrain.terrain_ruggedness_index(dem))
# ds['roughness_diff'] = (["y", "x"], xdem.terrain.roughness(dem, 15))
# ds['rugosity_diff'] = (('y','x'), xdem.terrain.rugosity(dem, resolution = (1.5, 1.5)))
# ds['FR_diff'] = (('y','x'), xdem.terrain.fractal_roughness(dem, 15))
# ds['prcurv_diff'] = (["y", "x"], xdem.terrain.profile_curvature(dem, resolution = (1.5, 1.5)))
# ds['plcurv_diff'] = (["y", "x"], xdem.terrain.planform_curvature(dem, resolution = (1.5, 1.5)))
